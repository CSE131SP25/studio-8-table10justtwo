...
public class Quiz {
	...
	public static void main(String[] args) {
		...
		MultipleChoiceQuestion q2 = new MultipleChoiceQuestion("What is the capital of France?", "1", 2, options);
		SelectAllQuestion q3 = new SelectAllQuestion("Select all European capitals:", "13", options);
